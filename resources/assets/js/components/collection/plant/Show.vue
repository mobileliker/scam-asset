...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            load() {
                axios.get('/api/collection/plant/' + this.$route.params.id)
                    .then(response => {
                        ...
                        axios.get('api/collection/plant/' + this.$route.params.id + '/relate', this.list.options)
                            .then(response => {
                                //console.log(response.data);
                ...
                axios.get('api/collection/plant/' + this.$route.params.id + '/image')
                    .then(response => {
                        //console.log(response.data);
