          ...
          <el-tabs v-model="tabName" type="card">
            ...
            <el-form ref="asset1" :model="asset" label-width="80px" :rules="rules1">
              ...
              <el-form-item label="入账日期"  prop="post_date_obj">
                <el-date-picker v-model="post_date_obj" type="date" placeholder="选择日期" @change="postDateChange"></el-date-picker>
              </el-form-item>
                ...
                <el-form ref="asset2" :model="asset" label-width="80px" :rules="rules2">
                    <el-col :lg="12">
                      ...
                      <el-form-item label="购置日期" prop="purchase_date_obj">
                        <el-date-picker v-model="purchase_date_obj" type="date" placeholder="购置日期"></el-date-picker>
                      </el-form-item>
        ...
        mounted() {
            ...
            axios.get('/admin/asset/' + this.$route.params.id + '/edit')
                .then( response => {
                    ...
                    this.post_date_obj = response.data.post_date;
                    this.purchase_date_obj = response.data.purchase_date;
            });
        },
        watch : {
            'asset.price' :{
